...
import de.muenchen.itm.eakte.schnittstelle.rest_v2.server_stubs.model.AttributbeschreibungenListeResponse;
...
@Validated
@Controller
@Tag(name = "Attributbeschreibungen", description = "the Attributbeschreibungen API")
public interface AttributbeschreibungenApi {
     ...
     */
    @Operation(
        operationId = "leseAttributebeschreibungen",
        summary = "Attribut-Metadaten abrufen",
        description = "Mit diesem Aufruf können die verwendbaren Attribute abgerufen werden.\\ \\ Diese Metadaten enthalten auch Referenzen auf den Kontext der Attribute, also ob es sich um ein Standard-Metadatum der eGov-Suite handelt, für welchen Schriftguttyp es gilt (Akte, Vorgang, Dokument) und welche Definition für Verfahren bzw. welches Formular die Definition des Attributs beinhaltet. ",
        tags = { "Attributbeschreibungen" },
        responses = {
            @ApiResponse(responseCode = "200", description = "OK", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = AttributbeschreibungenListeResponse.class))
            }),
    ...
    @RequestMapping(
        ...
        value = AttributbeschreibungenApi.PATH_LESE_ATTRIBUTEBESCHREIBUNGEN,
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"attributbeschreibungenListe\" : [ { \"maximaleTextLaenge\" : 0, \"pflichtFeld\" : true, \"eigeneUrl\" : \"/v2/Ressourcen/ressourcenId\", \"bezeichnung\" : \"Aktenführenden Organisationseinheit\", \"referenzSchriftgutObjektklasseOderFormular\" : \"Akte\", \"aufzaehlungswerte\" : [ { \"kurzbezeichnungDesWerts\" : \"Pizza Napoli\", \"schluessel\" : \"4711\" }, { \"kurzbezeichnungDesWerts\" : \"Pizza Napoli\", \"schluessel\" : \"4711\" } ], \"referenzAttribut\" : \"COOELAK@1.1001:fielouobj\", \"datentyp\" : \"Zeichenkette\", \"beschreibung\" : \"Beschreibung der Semantik des Attributs (umfänglich, ggf. mehrzeilig).\" }, { \"maximaleTextLaenge\" : 0, \"pflichtFeld\" : true, \"eigeneUrl\" : \"/v2/Ressourcen/ressourcenId\", \"bezeichnung\" : \"Aktenführenden Organisationseinheit\", \"referenzSchriftgutObjektklasseOderFormular\" : \"Akte\", \"aufzaehlungswerte\" : [ { \"kurzbezeichnungDesWerts\" : \"Pizza Napoli\", \"schluessel\" : \"4711\" }, { \"kurzbezeichnungDesWerts\" : \"Pizza Napoli\", \"schluessel\" : \"4711\" } ], \"referenzAttribut\" : \"COOELAK@1.1001:fielouobj\", \"datentyp\" : \"Zeichenkette\", \"beschreibung\" : \"Beschreibung der Semantik des Attributs (umfänglich, ggf. mehrzeilig).\" } ], \"success\" : true, \"anzahlAttributbeschreibungen\" : 3, \"error\" : { \"easDetail\" : \"easDetail\", \"easFehler\" : \"easFehler\", \"easFehlercode\" : 0 } }";
