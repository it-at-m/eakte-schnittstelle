...
public interface VorgangApi {
    ...
    default ResponseEntity<VorgangListeResponse> sucheVorgaenge(
        ...
        @Parameter(name = "limit", description = "", in = ParameterIn.QUERY) @Valid @RequestParam(value = "limit", required = false, defaultValue = "100") Optional<@Min(value = 1) @Max(value = 10000) Integer> limit,
