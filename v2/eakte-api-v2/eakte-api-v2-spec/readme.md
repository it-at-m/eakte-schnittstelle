...
Für Fälle, in denen eine einzige Spezifikationsdatei bevorzugt wird, wird im parallel liegenden Maven-Modul 'eakte-api-v1-spec-single-file' eine solche automatisch generiert.
