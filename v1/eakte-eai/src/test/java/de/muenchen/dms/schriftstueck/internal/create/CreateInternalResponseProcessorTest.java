...
class CreateInternalResponseProcessorTest {
  ...
  private CreateInternalResponseProcessor processor;

  @BeforeEach
  public void setUp() {
    processor = new CreateInternalResponseProcessor();
  }
  ...
  private Exchange erzeugeExchangeObjekt(CreateInternalGIResponse response) {
  ...
  private void pruefeEAIAntwort(Exchange exchange) throws IOException {
    ...
    CreateInternalResponseDTO antwort =
        mapper.createParser(body).readValueAs(CreateInternalResponseDTO.class);
  ...
  private CreateInternalGIResponse erzeugeDmsAntwortOhneFehler() {
    CreateInternalGIResponse response = new CreateInternalGIResponse();
