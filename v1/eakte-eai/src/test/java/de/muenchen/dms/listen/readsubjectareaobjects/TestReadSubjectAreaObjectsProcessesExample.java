...
public class TestReadSubjectAreaObjectsProcessesExample {
  static ReadSubjectAreaGIObjectsResponse erzeugeAntwort() {
    final ObjectFactory objectFactory = new ObjectFactory();
    final ReadSubjectAreaGIObjectsResponse data =
        objectFactory.createReadSubjectAreaGIObjectsResponse();
    data.setStatus(0);
