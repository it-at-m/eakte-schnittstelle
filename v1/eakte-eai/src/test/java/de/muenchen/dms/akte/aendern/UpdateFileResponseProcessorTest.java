...
@DisplayName("[Akte aendern] Die Testklasse prüft die Verarbeitung der SOAP-Antwort")
class UpdateFileResponseProcessorTest {
  ...
  private UpdateFileResponseProcessor processor;

  @BeforeEach
  void setUp() {
    processor = new UpdateFileResponseProcessor();
  }
  ...
  private Exchange erzeugeExchangeObjekt(UpdateFileGIResponse response) {
  ...
  private UpdateFileGIResponse erzeugeDmsAntwortOhneFehler() {
    UpdateFileGIResponse response = new UpdateFileGIResponse();
  ...
  private UpdateFileGIResponse erzeugeDmsAntwortMitFehler() {
    UpdateFileGIResponse response = new UpdateFileGIResponse();
