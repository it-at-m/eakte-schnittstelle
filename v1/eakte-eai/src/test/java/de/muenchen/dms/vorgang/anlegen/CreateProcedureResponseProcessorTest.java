...
@DisplayName("[Vorgang anlegen] Die Testklasse prüft die Verarbeitung der SOAP-Antwort")
class CreateProcedureResponseProcessorTest {
  ...
  private CreateProcedureResponseProcessor processor;

  @BeforeEach
  void setUp() {
    processor = new CreateProcedureResponseProcessor();
  }
  ...
  private Exchange erzeugeExchangeObjekt(CreateProcedureGIResponse response) {
  ...
  private CreateProcedureGIResponse erzeugeDmsAntwortOhneFehler() {
    CreateProcedureGIResponse response = new CreateProcedureGIResponse();
  ...
  private CreateProcedureGIResponse erzeugeDmsAntwortMitFehler() {
    CreateProcedureGIResponse response = new CreateProcedureGIResponse();
