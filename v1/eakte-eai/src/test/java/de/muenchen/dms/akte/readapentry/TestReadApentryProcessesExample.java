...
public class TestReadApentryProcessesExample {
  private TestReadApentryProcessesExample() {}

  static ReadApentryGIResponse erzeugeAntwort() {
    final ObjectFactory objectFactory = new ObjectFactory();
    final ReadApentryGIResponse data = objectFactory.createReadApentryGIResponse();
    data.setStatus(0);
