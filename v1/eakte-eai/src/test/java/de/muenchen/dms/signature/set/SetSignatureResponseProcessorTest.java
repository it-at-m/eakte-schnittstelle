...
class SetSignatureResponseProcessorTest {
  private static final int NO_ERROR_CODE = 0;

  private SetSignatureResponseProcessor processor;

  @BeforeEach
  void setUp() {
    processor = new SetSignatureResponseProcessor();
  }
  ...
  private Exchange erzeugeExchangeObjekt(SetSignatureObjectGIResponse response) {
  ...
  private SetSignatureObjectGIResponse erzeugeDmsAntwortOhneFehler() {
    SetSignatureObjectGIResponse response = new SetSignatureObjectGIResponse();
