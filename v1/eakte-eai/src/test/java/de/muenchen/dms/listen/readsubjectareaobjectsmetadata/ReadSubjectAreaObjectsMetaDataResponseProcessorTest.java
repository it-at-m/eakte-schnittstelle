...
class ReadSubjectAreaObjectsMetaDataResponseProcessorTest {

  private static final int NO_ERROR_CODE = 0;

  private ReadSubjectAreaObjectsMetaDataResponseProcessor processor;

  @BeforeEach
  public void setUp() {
    processor = new ReadSubjectAreaObjectsMetaDataResponseProcessor();
  }
  ...
  private Exchange erzeugeExchangeObjekt(ReadSubjectAreaGIObjectsMetaDataResponse response) {
  ...
  private ReadSubjectAreaGIObjectsMetaDataResponse erzeugeDmsAntwortOhneFehler() {
    ReadSubjectAreaGIObjectsMetaDataResponse response = new ReadSubjectAreaGIObjectsMetaDataResponse();
  ...
  private void pruefeEAIAnwort(Exchange exchange) throws IOException {
    ...
    ReadSubjectAreaObjectsMetaDataResponseDTO antwort =
        mapper.createParser(body).readValueAs(ReadSubjectAreaObjectsMetaDataResponseDTO.class);
