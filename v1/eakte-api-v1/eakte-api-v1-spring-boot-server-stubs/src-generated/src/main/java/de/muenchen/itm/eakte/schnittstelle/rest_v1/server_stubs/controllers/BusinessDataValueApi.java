...
import de.muenchen.itm.eakte.schnittstelle.rest_v1.server_stubs.model.UpdateBusinessDataValueDTO;
...
@Validated
@Controller
@Tag(name = "/businessDataValue", description = "the /businessDataValue API")
public interface BusinessDataValueApi {

    default Optional<NativeWebRequest> getRequest() {
        return Optional.empty();
    }

    String PATH_UPDATE_BUSINESS_DATA_VALUE = "/businessDataValue/{objaddress}";
    /**
     * PUT /businessDataValue/{objaddress} : Setzen/Aktualisieren von Fachdaten
     * Diese Funktion soll bei neuen Schnittstellen nicht mehr benutzt werden.&lt;br&gt; Dafür gibt es die neue Funktion für Verfahrensdaten PUT /userFormsData 
     *
     ...
     * @param updateBusinessDataValueDTO  (required)
     ...
     */
    @Operation(
        operationId = "updateBusinessDataValue",
        summary = "Setzen/Aktualisieren von Fachdaten",
        description = "Diese Funktion soll bei neuen Schnittstellen nicht mehr benutzt werden.<br> Dafür gibt es die neue Funktion für Verfahrensdaten PUT /userFormsData ",
        tags = { "/businessDataValue" },
        responses = {
    ...
    @RequestMapping(
        ...
        value = BusinessDataValueApi.PATH_UPDATE_BUSINESS_DATA_VALUE,
        produces = { "application/json" },
        consumes = { "application/json" }
    )
    default ResponseEntity<Void> updateBusinessDataValue(
        ...
        @Parameter(name = "UpdateBusinessDataValueDTO", description = "", required = true) @Valid @RequestBody UpdateBusinessDataValueDTO updateBusinessDataValueDTO,
