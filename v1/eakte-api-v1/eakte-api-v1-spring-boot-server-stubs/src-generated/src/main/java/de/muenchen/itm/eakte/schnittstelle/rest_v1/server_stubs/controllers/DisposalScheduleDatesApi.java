...
import de.muenchen.itm.eakte.schnittstelle.rest_v1.server_stubs.model.SetDisposalScheduleDateAnfrageDTO;
import de.muenchen.itm.eakte.schnittstelle.rest_v1.server_stubs.model.SetDisposalScheduleDateAntwortDTO;
...
@Validated
@Controller
@Tag(name = "/disposalScheduleDates", description = "the /disposalScheduleDates API")
public interface DisposalScheduleDatesApi {

    default Optional<NativeWebRequest> getRequest() {
        return Optional.empty();
    }

    String PATH_DISPOSAL_SCHEDULE_DATE = "/disposalScheduleDates/{objaddress}";
    /**
     * PUT /disposalScheduleDates/{objaddress} : Aufbewahrungsdatum setzen
     * Bei Akten und Vorgängen kann das vorgesehene Endedatum der Aufbewahrung geändert werden, nachdem sie z.A. gesetzt wurden.&lt;br&gt; Das angegebene Datum in der Eigenschaft „Aufbewahrung.vorgesehen“ [COOELAK@1.1001:filelifetime.COOELAK@1.1001:offltscheduled]  wird überschrieben und das Datum (FSCSCHEDULE@1.1001:nddate) des Fristen-Objekts vom Typ Aufbewahrung. 
     *
     ...
     * @param setDisposalScheduleDateAnfrageDTO  (required)
     ...
     */
    @Operation(
        operationId = "disposalScheduleDate",
        summary = "Aufbewahrungsdatum setzen",
        description = "Bei Akten und Vorgängen kann das vorgesehene Endedatum der Aufbewahrung geändert werden, nachdem sie z.A. gesetzt wurden.<br> Das angegebene Datum in der Eigenschaft „Aufbewahrung.vorgesehen“ [COOELAK@1.1001:filelifetime.COOELAK@1.1001:offltscheduled]  wird überschrieben und das Datum (FSCSCHEDULE@1.1001:nddate) des Fristen-Objekts vom Typ Aufbewahrung. ",
        tags = { "/disposalScheduleDates" },
        responses = {
            @ApiResponse(responseCode = "200", description = "OK", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = SetDisposalScheduleDateAntwortDTO.class))
            }),
    ...
    @RequestMapping(
        ...
        value = DisposalScheduleDatesApi.PATH_DISPOSAL_SCHEDULE_DATE,
        produces = { "application/json" },
        consumes = { "application/json" }
    )
    default ResponseEntity<SetDisposalScheduleDateAntwortDTO> disposalScheduleDate(
        ...
        @Parameter(name = "SetDisposalScheduleDateAnfrageDTO", description = "", required = true) @Valid @RequestBody SetDisposalScheduleDateAnfrageDTO setDisposalScheduleDateAnfrageDTO,
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"objname\" : \"Eingangspost vom 21.10.2016 (0010 A20 011-4-0006-0001)\", \"objid\" : \"COO.1.2301.1.1042441\" }";
