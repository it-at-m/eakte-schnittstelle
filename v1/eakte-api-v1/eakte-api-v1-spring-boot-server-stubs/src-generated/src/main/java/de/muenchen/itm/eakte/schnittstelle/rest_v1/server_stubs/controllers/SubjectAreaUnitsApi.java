...
import de.muenchen.itm.eakte.schnittstelle.rest_v1.server_stubs.model.CreateSubjectAreaUnitAnfrageDTO;
...
@Validated
@Controller
@Tag(name = "/subjectAreaUnits", description = "the /subjectAreaUnits API")
public interface SubjectAreaUnitsApi {

    default Optional<NativeWebRequest> getRequest() {
        return Optional.empty();
    }

    String PATH_CREATE_SUBJECT_AREA_UNIT = "/subjectAreaUnits";
    /**
     * POST /subjectAreaUnits : Betreffseinheit anlegen
     * Ein neuer Aktenplaneintrag [COOELAK@1.1001:SubjectArea] des Aktenplaneintragstyps „Betreffseinheit“  wird unter dem angegebenen übergeordneten Aktenplaneintrag erstellt.&lt;br&gt; Beim Anlegen von neuen Aktenplaneinträgen wird die  auf dem angegebenen übergeordneten Aktenplaneintrag angegebene Zugriffsdefinition übernommen. 
     *
     * @param userlogin **Benutzer-Login** (Benutzer-Kontext für den SOAP-Aufruf)&lt;br&gt; Log-in-Name des Benutzerobjekts  (required)
     * @param createSubjectAreaUnitAnfrageDTO  (required)
     ...
     */
    @Operation(
        operationId = "createSubjectAreaUnit",
        summary = "Betreffseinheit anlegen",
        description = "Ein neuer Aktenplaneintrag [COOELAK@1.1001:SubjectArea] des Aktenplaneintragstyps „Betreffseinheit“  wird unter dem angegebenen übergeordneten Aktenplaneintrag erstellt.<br> Beim Anlegen von neuen Aktenplaneinträgen wird die  auf dem angegebenen übergeordneten Aktenplaneintrag angegebene Zugriffsdefinition übernommen. ",
        tags = { "/subjectAreaUnits" },
        responses = {
    ...
    @RequestMapping(
        ...
        value = SubjectAreaUnitsApi.PATH_CREATE_SUBJECT_AREA_UNIT,
        produces = { "application/json" },
        consumes = { "application/json" }
    )
    default ResponseEntity<DmsObjektResponse> createSubjectAreaUnit(
        ...
        @Parameter(name = "CreateSubjectAreaUnitAnfrageDTO", description = "", required = true) @Valid @RequestBody CreateSubjectAreaUnitAnfrageDTO createSubjectAreaUnitAnfrageDTO,
