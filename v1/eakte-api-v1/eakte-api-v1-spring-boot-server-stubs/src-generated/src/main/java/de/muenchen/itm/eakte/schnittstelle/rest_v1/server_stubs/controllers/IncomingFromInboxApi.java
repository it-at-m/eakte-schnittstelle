...
import de.muenchen.itm.eakte.schnittstelle.rest_v1.server_stubs.model.CreateIncomingFromInboxRequestDTO;
...
@Validated
@Controller
@Tag(name = "/incomingFromInbox", description = "the /incomingFromInbox API")
public interface IncomingFromInboxApi {

    default Optional<NativeWebRequest> getRequest() {
        return Optional.empty();
    }

    String PATH_CREATE_INCOMING_FROM_INBOX = "/incomingFromInbox";
    /**
     * POST /incomingFromInbox : Erfassen eines Eingangs aus dem Postkorb
     * Schriftstücke eines Postkorbs werden als Eingangsdokument erfasst.&lt;br&gt; Eingänge können nur in bereits bestehenden Vorgängen angelegt werden. 
     *
     * @param userlogin **Benutzer-Login** (Benutzer-Kontext für den SOAP-Aufruf)&lt;br&gt; Log-in-Name des Benutzerobjekts  (required)
     * @param createIncomingFromInboxRequestDTO  (required)
     ...
     */
    @Operation(
        operationId = "createIncomingFromInbox",
        summary = "Erfassen eines Eingangs aus dem Postkorb",
        description = "Schriftstücke eines Postkorbs werden als Eingangsdokument erfasst.<br> Eingänge können nur in bereits bestehenden Vorgängen angelegt werden. ",
        tags = { "/incomingFromInbox" },
        responses = {
    ...
    @RequestMapping(
        ...
        value = IncomingFromInboxApi.PATH_CREATE_INCOMING_FROM_INBOX,
        produces = { "application/json" },
        consumes = { "application/json" }
    )
    default ResponseEntity<DmsObjektResponse> createIncomingFromInbox(
        ...
        @Parameter(name = "CreateIncomingFromInboxRequestDTO", description = "", required = true) @Valid @RequestBody CreateIncomingFromInboxRequestDTO createIncomingFromInboxRequestDTO,
