...
import de.muenchen.itm.eakte.schnittstelle.rest_v1.server_stubs.model.ReadSubjectAreaObjectsAntwortDTO;
...
@Validated
@Controller
@Tag(name = "/subjectAreas", description = "the /subjectAreas API")
public interface SubjectAreasApi {

    default Optional<NativeWebRequest> getRequest() {
        return Optional.empty();
    }

    String PATH_READ_SUBJECT_AREA_OBJECT = "/subjectAreas/{objaddress}";
    /**
     * GET /subjectAreas/{objaddress} : Liste von Sachakten auslesen
     * Ausgabe aller Sachakten unter dem übergebenen Aktenplaneintrag.&lt;br&gt; Stornierte Objekte können nicht ausgelesen werden,  d.h. Objekte mit dem Status „Storniert“ [FSCFOLIO@1.1001:objdocstate&#x3D;Storniert]  werden gefiltert und nicht zurückgegeben.&lt;br&gt; Über die optionalen Parameter können die auszulesenden Akten vorgefiltert werden,  d.h. es werden lediglich die Objekte übermittelt, auf welche die optionalen Parameter zutreffen. 
     *
     ...
     */
    @Operation(
        operationId = "readSubjectAreaObject",
        summary = "Liste von Sachakten auslesen",
        description = "Ausgabe aller Sachakten unter dem übergebenen Aktenplaneintrag.<br> Stornierte Objekte können nicht ausgelesen werden,  d.h. Objekte mit dem Status „Storniert“ [FSCFOLIO@1.1001:objdocstate=Storniert]  werden gefiltert und nicht zurückgegeben.<br> Über die optionalen Parameter können die auszulesenden Akten vorgefiltert werden,  d.h. es werden lediglich die Objekte übermittelt, auf welche die optionalen Parameter zutreffen. ",
        tags = { "/subjectAreas" },
        responses = {
            @ApiResponse(responseCode = "200", description = "OK", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = ReadSubjectAreaObjectsAntwortDTO.class))
            }),
    ...
    @RequestMapping(
        ...
        value = SubjectAreasApi.PATH_READ_SUBJECT_AREA_OBJECT,
        produces = { "application/json" }
    )
    default ResponseEntity<ReadSubjectAreaObjectsAntwortDTO> readSubjectAreaObject(
