...
import de.muenchen.itm.eakte.schnittstelle.rest_v1.server_stubs.model.AddAddresseeRequestDTO;
...
@Validated
@Controller
@Tag(name = "/addAddressees", description = "the /addAddressees API")
public interface AddAddresseesApi {

    default Optional<NativeWebRequest> getRequest() {
        return Optional.empty();
    }

    String PATH_ADD_ADDRESSEE = "/addAddressees/{objaddress}";
    /**
     * PUT /addAddressees/{objaddress} : Hinzufügen eines Freitextadressaten bei Dokumenten oder Vorgängen
     *
     ...
     * @param addAddresseeRequestDTO  (required)
     ...
     */
    @Operation(
        operationId = "addAddressee",
        summary = "Hinzufügen eines Freitextadressaten bei Dokumenten oder Vorgängen",
        tags = { "/addAddressees" },
        responses = {
    ...
    @RequestMapping(
        ...
        value = AddAddresseesApi.PATH_ADD_ADDRESSEE,
        produces = { "application/json" },
        consumes = { "application/json" }
    )
    default ResponseEntity<Void> addAddressee(
        ...
        @Parameter(name = "AddAddresseeRequestDTO", description = "", required = true) @Valid @RequestBody AddAddresseeRequestDTO addAddresseeRequestDTO,
