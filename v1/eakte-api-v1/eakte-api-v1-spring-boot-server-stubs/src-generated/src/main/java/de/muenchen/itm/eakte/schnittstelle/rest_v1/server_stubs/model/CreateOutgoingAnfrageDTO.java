...
import de.muenchen.itm.eakte.schnittstelle.rest_v1.server_stubs.model.UserFormsReferenz;
...
public class CreateOutgoingAnfrageDTO {
  ...
  /**
   * Objekt-ID (COO-Adresse) des Vorgangs<br> Wenn kein Vorgang angegeben wird, soll das erzeugte Erledigungsdokument am Schreibtisch des Benutzers abgelegt werden. 
   * @return referrednumber
   */
  @NotNull 
  @Schema(name = "referrednumber", example = "COO.1.2301.1.1042432", description = "Objekt-ID (COO-Adresse) des Vorgangs<br> Wenn kein Vorgang angegeben wird, soll das erzeugte Erledigungsdokument am Schreibtisch des Benutzers abgelegt werden. ", requiredMode = Schema.RequiredMode.REQUIRED)
  ...
  /**
   * Bezug zum Eingang<br> Bei Bedarf kann die COO-Adresse des Eingangs angegeben werden, damit ein direkter Bezug zwischen Eingang und Erledigung hergestellt werden kann. 
   * @return referredincoming
   */
  
  @Schema(name = "referredincoming", example = "COO.1.2301.1.1042441", description = "Bezug zum Eingang<br> Bei Bedarf kann die COO-Adresse des Eingangs angegeben werden, damit ein direkter Bezug zwischen Eingang und Erledigung hergestellt werden kann. ", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  /**
   * Sonstige Anlagen<br> Freitextfeld, um zusätzliche Anlagen zu benennen, die nicht elektronisch erfasst wurden (z.B. Baupläne) 
   * @return incattachments
   */
  
  @Schema(name = "incattachments", example = "Ausfüllhilfe Antrag auf Baugenehmigung", description = "Sonstige Anlagen<br> Freitextfeld, um zusätzliche Anlagen zu benennen, die nicht elektronisch erfasst wurden (z.B. Baupläne) ", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
