...
@Validated
@Controller
@Tag(name = "/depositObjects", description = "the /depositObjects API")
public interface DepositObjectsApi {

    default Optional<NativeWebRequest> getRequest() {
        return Optional.empty();
    }

    String PATH_DEPOSIT_OBJECT = "/depositObjects/{objaddress}";
    /**
     * PUT /depositObjects/{objaddress} : z.A. setzen von Akten und Vorgängen
     * Der Status der Akte oder des Vorgangs wird „z.A.“ gesetzt. * Alle Vorgänge unter der betreffenden Akte werden z.A. gesetzt. * Für die betreffende Akte wird das Feld \&quot;gültig bis\&quot;  auf das Datum der Durchführung des Calls gesetzt. * Neue Vorgänge können nach dem Bayern Standard nicht mehr angelegt und  Inhalte nicht mehr bearbeitet werden. * Das Transfer- und Aussonderungsdatum für Vorgänge wird  auf Basis von Aufbewahrungsfrist und Aussonderungsart berechnet und gesetzt. * Eine Akte kann lediglich dann z.A. geschrieben werden,  wenn bei keinem der darunterliegenden Vorgänge ein offener Prozess/Laufweg vorliegt. 
     *
     ...
     */
    @Operation(
        operationId = "depositObject",
        summary = "z.A. setzen von Akten und Vorgängen",
        description = "Der Status der Akte oder des Vorgangs wird „z.A.“ gesetzt. * Alle Vorgänge unter der betreffenden Akte werden z.A. gesetzt. * Für die betreffende Akte wird das Feld \"gültig bis\"  auf das Datum der Durchführung des Calls gesetzt. * Neue Vorgänge können nach dem Bayern Standard nicht mehr angelegt und  Inhalte nicht mehr bearbeitet werden. * Das Transfer- und Aussonderungsdatum für Vorgänge wird  auf Basis von Aufbewahrungsfrist und Aussonderungsart berechnet und gesetzt. * Eine Akte kann lediglich dann z.A. geschrieben werden,  wenn bei keinem der darunterliegenden Vorgänge ein offener Prozess/Laufweg vorliegt. ",
        tags = { "/depositObjects" },
        responses = {
    ...
    @RequestMapping(
        ...
        value = DepositObjectsApi.PATH_DEPOSIT_OBJECT,
        produces = { "application/json" }
    )
    default ResponseEntity<DmsObjektResponse> depositObject(
