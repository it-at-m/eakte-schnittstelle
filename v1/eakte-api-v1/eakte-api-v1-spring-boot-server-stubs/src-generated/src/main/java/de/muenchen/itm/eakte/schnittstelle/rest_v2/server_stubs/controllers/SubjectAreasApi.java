...
public interface SubjectAreasApi {
     ...
     * Ausgabe aller Sachakten unter dem übergebenen Aktenplaneintrag.\\ Stornierte Objekte können nicht ausgelesen werden,  d.h. Objekte mit dem Status „Storniert“ [FSCFOLIO@1.1001:objdocstate&#x3D;Storniert]  werden gefiltert und nicht zurückgegeben.\\ Über die optionalen Parameter können die auszulesenden Akten vorgefiltert werden,  d.h. es werden lediglich die Objekte übermittelt, auf welche die optionalen Parameter zutreffen. 
     *
    ...
    @Operation(
        ...
        description = "Ausgabe aller Sachakten unter dem übergebenen Aktenplaneintrag.\\ Stornierte Objekte können nicht ausgelesen werden,  d.h. Objekte mit dem Status „Storniert“ [FSCFOLIO@1.1001:objdocstate=Storniert]  werden gefiltert und nicht zurückgegeben.\\ Über die optionalen Parameter können die auszulesenden Akten vorgefiltert werden,  d.h. es werden lediglich die Objekte übermittelt, auf welche die optionalen Parameter zutreffen. ",
        tags = { "/subjectAreas" },
        responses = {
