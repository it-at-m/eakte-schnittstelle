...
import de.muenchen.itm.eakte.schnittstelle.rest_v1.server_stubs.model.CreateObjectAndImportToInboxDTO;
import de.muenchen.itm.eakte.schnittstelle.rest_v1.server_stubs.model.CreateObjectAndImportToInboxResponseDTO;
...
@Validated
@Controller
@Tag(name = "/objectAndImportToInbox", description = "the /objectAndImportToInbox API")
public interface ObjectAndImportToInboxApi {

    default Optional<NativeWebRequest> getRequest() {
        return Optional.empty();
    }

    String PATH_CREATE_OBJECT_AND_IMPORT_TO_INBOX = "/objectAndImportToInbox";
    /**
     * POST /objectAndImportToInbox : Erzeugen eines Schriftstückes in einem Postkorb
     *
     ...
     */
    @Operation(
        operationId = "createObjectAndImportToInbox",
        summary = "Erzeugen eines Schriftstückes in einem Postkorb",
        tags = { "/objectAndImportToInbox" },
        responses = {
            @ApiResponse(responseCode = "200", description = "OK", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = CreateObjectAndImportToInboxResponseDTO.class))
            }),
    ...
    @RequestMapping(
        ...
        value = ObjectAndImportToInboxApi.PATH_CREATE_OBJECT_AND_IMPORT_TO_INBOX,
        produces = { "application/json" },
        consumes = { "multipart/form-data" }
    )
    default ResponseEntity<CreateObjectAndImportToInboxResponseDTO> createObjectAndImportToInbox(
        ...
        @Parameter(name = "params", description = "", required = true) @Valid @RequestPart(value = "params", required = true) CreateObjectAndImportToInboxDTO params,
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"listcontents\" : [ { \"fileextension\" : \"txt\", \"objcreatedat\" : \"2018-07-23T08:59:52+01:00\", \"objaddress\" : \"COO.1.2301.1.1041875\", \"filename\" : \"Brief an Dr. Müller\", \"contsize\" : \"5\", \"objclass\" : \"Erledigung\", \"objchangedby\" : { \"string\" : [ \"Auto\", \"Bahn\", \"Flugzeug\" ] }, \"objcreatedby\" : { \"string\" : [ \"Auto\", \"Bahn\", \"Flugzeug\" ] }, \"objmodifiedat\" : \"2018-07-23T10:39:32+01:00\" }, { \"fileextension\" : \"txt\", \"objcreatedat\" : \"2018-07-23T08:59:52+01:00\", \"objaddress\" : \"COO.1.2301.1.1041875\", \"filename\" : \"Brief an Dr. Müller\", \"contsize\" : \"5\", \"objclass\" : \"Erledigung\", \"objchangedby\" : { \"string\" : [ \"Auto\", \"Bahn\", \"Flugzeug\" ] }, \"objcreatedby\" : { \"string\" : [ \"Auto\", \"Bahn\", \"Flugzeug\" ] }, \"objmodifiedat\" : \"2018-07-23T10:39:32+01:00\" } ] }";
