...
import de.muenchen.itm.eakte.schnittstelle.rest_v1.server_stubs.model.ReadDocumentObjectMetaDataResponseDTO;
...
@Validated
@Controller
@Tag(name = "/readDocumentObjectsMetaData", description = "the /readDocumentObjectsMetaData API")
public interface ReadDocumentObjectsMetaDataApi {

    default Optional<NativeWebRequest> getRequest() {
        return Optional.empty();
    }

    String PATH_READ_DOCUMENT_META_DATA = "/readDocumentObjectsMetaData/{objaddress}";
    /**
     * GET /readDocumentObjectsMetaData/{objaddress} : Liste aller Schriftstücke eines Dokuments mit Metadaten auslesen
     * Stornierte Objekte können nicht ausgelesen werden,  d.h. Objekte mit dem Status „Storniert“ [FSCFOLIO@1.1001:objdocstate&#x3D;Storniert] werden gefiltert und nicht zurückgegeben.&lt;br&gt; Über die optionalen Parameter können Schriftstücke zur Anzeige gemäß der gewählten Kriterien ausgewählt werden. 
     *
     ...
     */
    @Operation(
        operationId = "readDocumentMetaData",
        summary = "Liste aller Schriftstücke eines Dokuments mit Metadaten auslesen",
        description = "Stornierte Objekte können nicht ausgelesen werden,  d.h. Objekte mit dem Status „Storniert“ [FSCFOLIO@1.1001:objdocstate=Storniert] werden gefiltert und nicht zurückgegeben.<br> Über die optionalen Parameter können Schriftstücke zur Anzeige gemäß der gewählten Kriterien ausgewählt werden. ",
        tags = { "/readDocumentObjectsMetaData" },
        responses = {
    ...
    @RequestMapping(
        ...
        value = ReadDocumentObjectsMetaDataApi.PATH_READ_DOCUMENT_META_DATA,
        produces = { "application/json" }
    )
    default ResponseEntity<ReadDocumentObjectMetaDataResponseDTO> readDocumentMetaData(
