...
import de.muenchen.itm.eakte.schnittstelle.rest_v1.server_stubs.model.StartWorkflowDTO;
...
@Validated
@Controller
@Tag(name = "/startWorkflows", description = "the /startWorkflows API")
public interface StartWorkflowsApi {

    default Optional<NativeWebRequest> getRequest() {
        return Optional.empty();
    }

    String PATH_START_WORKFLOW = "/startWorkflows/{objaddress}";
    /**
     * PUT /startWorkflows/{objaddress} : Laufweg starten
     * Starten eines vordefinierten Workflows auf einem Schriftgutobjekt (Vorgang oder Umlaufmappe). Dabei wird das entsprechende Objekt sowie das Muster für Verfügung-Objekt als COO-Adresse übergeben. Dabei wird das entsprechende Objekt sowie das Muster für Verfügung-Objekt als COO-Adresse übergeben.
     *
     ...
     * @param startWorkflowDTO  (required)
    ...
    @Operation(
        ...
        summary = "Laufweg starten",
        description = "Starten eines vordefinierten Workflows auf einem Schriftgutobjekt (Vorgang oder Umlaufmappe). Dabei wird das entsprechende Objekt sowie das Muster für Verfügung-Objekt als COO-Adresse übergeben. Dabei wird das entsprechende Objekt sowie das Muster für Verfügung-Objekt als COO-Adresse übergeben.",
        tags = { "/startWorkflows" },
        responses = {
    ...
    @RequestMapping(
        ...
        value = StartWorkflowsApi.PATH_START_WORKFLOW,
        produces = { "application/json" },
        consumes = { "application/json" }
    )
    default ResponseEntity<Void> startWorkflow(
        ...
        @Parameter(name = "StartWorkflowDTO", description = "", required = true) @Valid @RequestBody StartWorkflowDTO startWorkflowDTO,
