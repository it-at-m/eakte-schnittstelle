...
import de.muenchen.itm.eakte.schnittstelle.rest_v1.server_stubs.model.ReadDocumentObjectsAntwortDTO;
...
@Validated
@Controller
@Tag(name = "/documentObjects", description = "the /documentObjects API")
public interface DocumentObjectsApi {

    default Optional<NativeWebRequest> getRequest() {
        return Optional.empty();
    }

    String PATH_READ_DOCUMENT_OBJECT = "/documentObjects/{objaddress}";
    /**
     * GET /documentObjects/{objaddress} : Liste von Schriftstücken auslesen
     * Stornierte Objekte können nicht ausgelesen werden,  d.h. Objekte mit dem Status „Storniert“ [FSCFOLIO@1.1001:objdocstate&#x3D;Storniert] werden gefiltert und nicht zurückgegeben.&lt;br&gt; Über die optionalen Parameter kann das Fachverfahren vorab eine Selektierung der Liste vornehmen,  d.h. es sollten lediglich die Objekte übermittelt werden auf welche die optionalen Parameter zutreffen. 
     *
     ...
     */
    @Operation(
        operationId = "readDocumentObject",
        summary = "Liste von Schriftstücken auslesen",
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "OK", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = ReadDocumentObjectsAntwortDTO.class))
            }),
    ...
    @RequestMapping(
        ...
        value = DocumentObjectsApi.PATH_READ_DOCUMENT_OBJECT,
        produces = { "application/json" }
    )
    default ResponseEntity<ReadDocumentObjectsAntwortDTO> readDocumentObject(
