...
import de.muenchen.itm.eakte.schnittstelle.rest_v1.server_stubs.model.UpdateSubjectAreaRequestDTO;
...
@Validated
@Controller
@Tag(name = "/subjectArea", description = "the /subjectArea API")
public interface SubjectAreaApi {

    default Optional<NativeWebRequest> getRequest() {
        return Optional.empty();
    }

    String PATH_UPDATE_SUBJECT_AREA = "/subjectArea/{objaddress}";
    /**
     * PUT /subjectArea/{objaddress} : Aktenplaneintrag ändern
     *
     ...
     * @param updateSubjectAreaRequestDTO  (required)
     ...
     */
    @Operation(
        operationId = "updateSubjectArea",
        summary = "Aktenplaneintrag ändern",
        tags = { "/subjectArea" },
        responses = {
    ...
    @RequestMapping(
        ...
        value = SubjectAreaApi.PATH_UPDATE_SUBJECT_AREA,
        produces = { "application/json" },
        consumes = { "application/json" }
    )
    default ResponseEntity<Void> updateSubjectArea(
        ...
        @Parameter(name = "UpdateSubjectAreaRequestDTO", description = "", required = true) @Valid @RequestBody UpdateSubjectAreaRequestDTO updateSubjectAreaRequestDTO,
