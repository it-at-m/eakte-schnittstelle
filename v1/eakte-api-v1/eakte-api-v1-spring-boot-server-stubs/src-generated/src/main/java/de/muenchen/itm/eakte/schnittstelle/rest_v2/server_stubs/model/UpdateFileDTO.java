...
public class UpdateFileDTO {
  ...
  /**
   * Transferfrist  Die Transferfrist beginnt gleichzeitig mit der Aufbewahrungsfrist, endet aber meist früher.  Während der Transferfrist können Vorgänge wieder aufleben und fortgeführt werden.<br> Die Vorgänge müssen nach Ende der Arbeiten erneut abgeschlossen werden und  die Aufbewahrungs- und die Transferfrist fangen wieder von Beginn an zu laufen.  Häufig werden Akten auf einen internen Langzeitspeicher oder in das Zwischenarchiv des Bundesarchivs ausgelagert.<br> Bei der LHM wird die Transferfrist nicht eingesetzt, da die Akten bis zur Übergabe an das Stadtarchiv in der eAkte verbleiben!<br> Die Fabasoft eGov Suite erlaubt auch nach Ablauf der Transferfrist bis zum Ende der Aufbewahrungsfrist \"z.A. aufheben\", um die Akte wieder bearbeiten zu können.<br> Daher wird die Transferfrist gleich der Aufbewahrungsfrist gesetzt und im Lebenszyklus nicht beachtet (auch keine Änderung der Zugriffsrechte). 
   * @return filearchivetimeOffltdeadline
   */
  
  @Schema(name = "filearchivetimeOffltdeadline", example = "10 Jahre", description = "Transferfrist  Die Transferfrist beginnt gleichzeitig mit der Aufbewahrungsfrist, endet aber meist früher.  Während der Transferfrist können Vorgänge wieder aufleben und fortgeführt werden.<br> Die Vorgänge müssen nach Ende der Arbeiten erneut abgeschlossen werden und  die Aufbewahrungs- und die Transferfrist fangen wieder von Beginn an zu laufen.  Häufig werden Akten auf einen internen Langzeitspeicher oder in das Zwischenarchiv des Bundesarchivs ausgelagert.<br> Bei der LHM wird die Transferfrist nicht eingesetzt, da die Akten bis zur Übergabe an das Stadtarchiv in der eAkte verbleiben!<br> Die Fabasoft eGov Suite erlaubt auch nach Ablauf der Transferfrist bis zum Ende der Aufbewahrungsfrist \"z.A. aufheben\", um die Akte wieder bearbeiten zu können.<br> Daher wird die Transferfrist gleich der Aufbewahrungsfrist gesetzt und im Lebenszyklus nicht beachtet (auch keine Änderung der Zugriffsrechte). ", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
