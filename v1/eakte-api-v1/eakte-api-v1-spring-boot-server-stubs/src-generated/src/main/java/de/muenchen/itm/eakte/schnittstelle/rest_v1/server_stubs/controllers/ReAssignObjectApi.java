...
import de.muenchen.itm.eakte.schnittstelle.rest_v1.server_stubs.model.ReAssignObjectDTO;
...
@Validated
@Controller
@Tag(name = "/reAssignObject", description = "the /reAssignObject API")
public interface ReAssignObjectApi {

    default Optional<NativeWebRequest> getRequest() {
        return Optional.empty();
    }

    String PATH_RE_ASSIGN_OBJECT = "/reAssignObject/{objaddress}";
    /**
     * PUT /reAssignObject/{objaddress} : Akte oder Vorgang umschreiben
     *
     ...
     * @param reAssignObjectDTO  (required)
     ...
     */
    @Operation(
        operationId = "reAssignObject",
        summary = "Akte oder Vorgang umschreiben",
        tags = { "/reAssignObject" },
        responses = {
    ...
    @RequestMapping(
        ...
        value = ReAssignObjectApi.PATH_RE_ASSIGN_OBJECT,
        produces = { "application/json" },
        consumes = { "application/json" }
    )
    default ResponseEntity<Void> reAssignObject(
        ...
        @Parameter(name = "ReAssignObjectDTO", description = "", required = true) @Valid @RequestBody ReAssignObjectDTO reAssignObjectDTO,
