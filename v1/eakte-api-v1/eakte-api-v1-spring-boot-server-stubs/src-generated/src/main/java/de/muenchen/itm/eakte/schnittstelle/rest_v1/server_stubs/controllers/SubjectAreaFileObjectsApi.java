...
import de.muenchen.itm.eakte.schnittstelle.rest_v1.server_stubs.model.ReadSubjectAreaFileAntwortDTO;
...
@Validated
@Controller
@Tag(name = "/subjectAreaFileObjects", description = "the /subjectAreaFileObjects API")
public interface SubjectAreaFileObjectsApi {

    default Optional<NativeWebRequest> getRequest() {
        return Optional.empty();
    }

    String PATH_READ_SUBJECT_AREA_FILE = "/subjectAreaFileObjects/{objaddress}";
    /**
     * GET /subjectAreaFileObjects/{objaddress} : Liste von Vorgängen einer Akte auslesen
     * Stornierte Objekte können nicht ausgelesen werden,  d.h. Objekte mit dem Status „Storniert“ [FSCFOLIO@1.1001:objdocstate&#x3D;Storniert]  werden gefiltert und nicht zurückgegeben.&lt;br&gt; Über die optionalen Parameter kann die Liste vorgefiltert werden,  d.h. es werden lediglich die Objekte übermittelt, auf welche die optionalen Parameter zutreffen. 
     *
     ...
     */
    @Operation(
        operationId = "readSubjectAreaFile",
        summary = "Liste von Vorgängen einer Akte auslesen",
        ...
        tags = { "/subjectAreaFileObjects" },
        responses = {
            @ApiResponse(responseCode = "200", description = "OK", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = ReadSubjectAreaFileAntwortDTO.class))
            }),
    ...
    @RequestMapping(
        ...
        value = SubjectAreaFileObjectsApi.PATH_READ_SUBJECT_AREA_FILE,
        produces = { "application/json" }
    )
    default ResponseEntity<ReadSubjectAreaFileAntwortDTO> readSubjectAreaFile(
