...
import de.muenchen.itm.eakte.schnittstelle.rest_v1.server_stubs.model.ReadProcedureObjectsAntwortDTO;
...
@Validated
@Controller
@Tag(name = "/procedureObjects", description = "the /procedureObjects API")
public interface ProcedureObjectsApi {

    default Optional<NativeWebRequest> getRequest() {
        return Optional.empty();
    }

    String PATH_READ_PROCEDURE_OBJECT = "/procedureObjects/{objaddress}";
    /**
     * GET /procedureObjects/{objaddress} : Liste von Dokumenten auslesen
     ...
     */
    @Operation(
        operationId = "readProcedureObject",
        summary = "Liste von Dokumenten auslesen",
        ...
        tags = { "/procedureObjects" },
        responses = {
            @ApiResponse(responseCode = "200", description = "OK", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = ReadProcedureObjectsAntwortDTO.class))
            }),
    ...
    @RequestMapping(
        ...
        value = ProcedureObjectsApi.PATH_READ_PROCEDURE_OBJECT,
        produces = { "application/json" }
    )
    default ResponseEntity<ReadProcedureObjectsAntwortDTO> readProcedureObject(
