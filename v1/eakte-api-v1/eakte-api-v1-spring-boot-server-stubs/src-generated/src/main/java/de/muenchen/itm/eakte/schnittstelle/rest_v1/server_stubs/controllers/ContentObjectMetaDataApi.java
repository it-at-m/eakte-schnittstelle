...
import de.muenchen.itm.eakte.schnittstelle.rest_v1.server_stubs.model.ReadContentObjectMetaDataAntwortDTO;
...
@Validated
@Controller
@Tag(name = "/contentObjectMetaData", description = "the /contentObjectMetaData API")
public interface ContentObjectMetaDataApi {

    default Optional<NativeWebRequest> getRequest() {
        return Optional.empty();
    }

    String PATH_READ_CONTENT_OBJECT_META_DATA = "/contentObjectMetaData/{objaddress}";
    /**
     * GET /contentObjectMetaData/{objaddress} : Schriftstück Metadaten lesen
     *
     ...
     */
    @Operation(
        operationId = "readContentObjectMetaData",
        summary = "Schriftstück Metadaten lesen",
        tags = { "/contentObjectMetaData" },
        responses = {
            @ApiResponse(responseCode = "200", description = "OK", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = ReadContentObjectMetaDataAntwortDTO.class))
            }),
    ...
    @RequestMapping(
        ...
        value = ContentObjectMetaDataApi.PATH_READ_CONTENT_OBJECT_META_DATA,
        produces = { "application/json" }
    )
    default ResponseEntity<ReadContentObjectMetaDataAntwortDTO> readContentObjectMetaData(
