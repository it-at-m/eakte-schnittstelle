...
import de.muenchen.itm.eakte.schnittstelle.rest_v1.server_stubs.model.ReadSubjectAreaObjectsMetaDataResponseDTO;
...
@Validated
@Controller
@Tag(name = "/readSubjectAreaObjectsMetaData", description = "the /readSubjectAreaObjectsMetaData API")
public interface ReadSubjectAreaObjectsMetaDataApi {

    default Optional<NativeWebRequest> getRequest() {
        return Optional.empty();
    }

    String PATH_READ_SUBJECT_AREA_OBJECTS_META_DATA = "/readSubjectAreaObjectsMetaData/{objaddress}";
    /**
     * GET /readSubjectAreaObjectsMetaData/{objaddress} : Liste aller Akten einer Betreffseinheit mit Metadaten auslesen
     * Stornierte Objekte können nicht ausgelesen werden,  d.h. Objekte mit dem Status „Storniert“ [FSCFOLIO@1.1001:objdocstate&#x3D;Storniert] werden gefiltert und nicht zurückgegeben.&lt;br&gt; Über die optionalen Parameter können Akten zur Anzeige gemäß der gewählten Kriterien ausgewählt werden. 
     *
     ...
     * @param propbostate Bearbeitungsstatus der darunterliegenden Objekte&lt;br&gt; Es muss die COO-Adresse des Bearbeitungsstatus übergeben werden.  Die Liste kann aus dem jeweiligen System generiert werden (Suche nach Status Komponentenobjekt im Verwaltungswerkzeug)  Je nach Bearbeitungsschritt mit dem Objekt können folgende (beispielhafte) Status vorliegen: * Erstellt * Weggelegt * z.A. verfügt * Schlusszeichnung * Schlusszeichnung abgelehnt * Billigung * Billigung abgelehnt * Mitgezeichnet * Mitzeichnung abgelehnt * Versand erzeugt * Versendet * Zu Bewerten * Bewertet * Dem Archiv übermittelt * Vom Archiv zurückgegeben bzw. Übernahme vom Archiv bestätigt * Vernichtet  (optional)
     ...
     */
    @Operation(
        operationId = "readSubjectAreaObjectsMetaData",
        summary = "Liste aller Akten einer Betreffseinheit mit Metadaten auslesen",
        description = "Stornierte Objekte können nicht ausgelesen werden,  d.h. Objekte mit dem Status „Storniert“ [FSCFOLIO@1.1001:objdocstate=Storniert] werden gefiltert und nicht zurückgegeben.<br> Über die optionalen Parameter können Akten zur Anzeige gemäß der gewählten Kriterien ausgewählt werden. ",
        tags = { "/readSubjectAreaObjectsMetaData" },
        responses = {
            @ApiResponse(responseCode = "200", description = "OK", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = ReadSubjectAreaObjectsMetaDataResponseDTO.class))
            }),
    ...
    @RequestMapping(
        ...
        value = ReadSubjectAreaObjectsMetaDataApi.PATH_READ_SUBJECT_AREA_OBJECTS_META_DATA,
        produces = { "application/json" }
    )
    default ResponseEntity<ReadSubjectAreaObjectsMetaDataResponseDTO> readSubjectAreaObjectsMetaData(
        ...
        @Parameter(name = "propbostate", description = "Bearbeitungsstatus der darunterliegenden Objekte<br> Es muss die COO-Adresse des Bearbeitungsstatus übergeben werden.  Die Liste kann aus dem jeweiligen System generiert werden (Suche nach Status Komponentenobjekt im Verwaltungswerkzeug)  Je nach Bearbeitungsschritt mit dem Objekt können folgende (beispielhafte) Status vorliegen: * Erstellt * Weggelegt * z.A. verfügt * Schlusszeichnung * Schlusszeichnung abgelehnt * Billigung * Billigung abgelehnt * Mitgezeichnet * Mitzeichnung abgelehnt * Versand erzeugt * Versendet * Zu Bewerten * Bewertet * Dem Archiv übermittelt * Vom Archiv zurückgegeben bzw. Übernahme vom Archiv bestätigt * Vernichtet ", in = ParameterIn.HEADER) @RequestHeader(value = "propbostate", required = false) Optional<String> propbostate,
        @Parameter(hidden = true) final HttpServletRequest servletRequest
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"businessobjecttype\" : [ { \"fileextension\" : \"fileextension\", \"objcreatedat\" : \"2000-01-23T04:56:07.000+00:00\", \"objaddress\" : \"objaddress\", \"objname\" : \"objname\", \"objowner\" : \"objowner\", \"contsize\" : \"contsize\", \"objou\" : \"objou\", \"objclass\" : \"objclass\", \"objchangedby\" : { \"string\" : [ \"Auto\", \"Bahn\", \"Flugzeug\" ] }, \"objcreatedby\" : { \"string\" : [ \"Auto\", \"Bahn\", \"Flugzeug\" ] }, \"objmodifiedat\" : \"2000-01-23T04:56:07.000+00:00\" }, { \"fileextension\" : \"fileextension\", \"objcreatedat\" : \"2000-01-23T04:56:07.000+00:00\", \"objaddress\" : \"objaddress\", \"objname\" : \"objname\", \"objowner\" : \"objowner\", \"contsize\" : \"contsize\", \"objou\" : \"objou\", \"objclass\" : \"objclass\", \"objchangedby\" : { \"string\" : [ \"Auto\", \"Bahn\", \"Flugzeug\" ] }, \"objcreatedby\" : { \"string\" : [ \"Auto\", \"Bahn\", \"Flugzeug\" ] }, \"objmodifiedat\" : \"2000-01-23T04:56:07.000+00:00\" } ] }";
