...
import de.muenchen.itm.eakte.schnittstelle.rest_v1.server_stubs.model.CreateOutgoingAnfrageDTO;
import de.muenchen.itm.eakte.schnittstelle.rest_v1.server_stubs.model.CreateOutgoingAntwortDTO;
import de.muenchen.itm.eakte.schnittstelle.rest_v1.server_stubs.model.DmsErrorResponse;
import org.springframework.lang.Nullable;
import de.muenchen.itm.eakte.schnittstelle.rest_v1.server_stubs.model.ReadOutgoingAntwortDTO;
import de.muenchen.itm.eakte.schnittstelle.rest_v1.server_stubs.model.UpdateOutgoingRequestDTO;
import de.muenchen.itm.eakte.schnittstelle.rest_v1.server_stubs.model.UpdateOutgoingResponseDTO;
...
public interface OutgoingsApi {
     ...
     * Bereits befüllte Werte werden überschrieben.  Bei keiner Übergabe bleiben die bestehenden Werte erhalten.&lt;br&gt; Ausnahme: Inhaltsobjekte können über diesen Aufruf nur hinzugefügt und  nicht ersetzt werden.&lt;br&gt; Bei jeder Änderung über die Schnittstelle  wird in der eGov-Suite eine neue Version des Objekts erzeugt.  Dies betrifft auch wiederholte Änderungen,  die durch einen Benutzer durchgeführt werden. 
     *
     * @param userlogin **Benutzer-Login** (Benutzer-Kontext für den SOAP-Aufruf)&lt;br&gt; Log-in-Name des Benutzerobjekts  (required)
     * @param objaddress Objekt-ID (COO-Adresse) des Objekts (required)
     * @param params  (required)
    ...
    @Operation(
        ...
        description = "Bereits befüllte Werte werden überschrieben.  Bei keiner Übergabe bleiben die bestehenden Werte erhalten.<br> Ausnahme: Inhaltsobjekte können über diesen Aufruf nur hinzugefügt und  nicht ersetzt werden.<br> Bei jeder Änderung über die Schnittstelle  wird in der eGov-Suite eine neue Version des Objekts erzeugt.  Dies betrifft auch wiederholte Änderungen,  die durch einen Benutzer durchgeführt werden. ",
        tags = { "/outgoings" },
        responses = {
            @ApiResponse(responseCode = "200", description = "OK", content = {
