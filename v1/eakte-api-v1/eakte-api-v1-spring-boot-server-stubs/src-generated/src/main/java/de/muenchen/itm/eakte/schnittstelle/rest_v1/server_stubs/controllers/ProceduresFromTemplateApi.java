...
import de.muenchen.itm.eakte.schnittstelle.rest_v1.server_stubs.model.CreateProcedureFromTemplateRequestDTO;
import de.muenchen.itm.eakte.schnittstelle.rest_v1.server_stubs.model.CreateProcedureFromTemplateResponseDTO;
...
@Validated
@Controller
@Tag(name = "/proceduresFromTemplate", description = "the /proceduresFromTemplate API")
public interface ProceduresFromTemplateApi {

    default Optional<NativeWebRequest> getRequest() {
        return Optional.empty();
    }

    String PATH_CREATE_PROCEDURE_FROM_TEMPLATE = "/proceduresFromTemplate";
    /**
     * POST /proceduresFromTemplate : Erzeugen von Vorgängen auf Basis einer Vorgangsvorlage
     *
     * @param userlogin **Benutzer-Login** (Benutzer-Kontext für den SOAP-Aufruf)&lt;br&gt; Log-in-Name des Benutzerobjekts  (required)
     * @param createProcedureFromTemplateRequestDTO  (required)
    ...
    @Operation(
        ...
        summary = "Erzeugen von Vorgängen auf Basis einer Vorgangsvorlage",
        tags = { "/proceduresFromTemplate" },
        responses = {
            @ApiResponse(responseCode = "200", description = "OK", content = {
                @Content(mediaType = "application/json", schema = @Schema(implementation = CreateProcedureFromTemplateResponseDTO.class))
            }),
    ...
    @RequestMapping(
        ...
        value = ProceduresFromTemplateApi.PATH_CREATE_PROCEDURE_FROM_TEMPLATE,
        produces = { "application/json" },
        consumes = { "application/json" }
    )
    default ResponseEntity<CreateProcedureFromTemplateResponseDTO> createProcedureFromTemplate(
        ...
        @Parameter(name = "CreateProcedureFromTemplateRequestDTO", description = "", required = true) @Valid @RequestBody CreateProcedureFromTemplateRequestDTO createProcedureFromTemplateRequestDTO,
        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"objname\" : \"2016 Anträge Firma XY\", \"objid\" : \"COO.1.2301.1.1042432\" }";
