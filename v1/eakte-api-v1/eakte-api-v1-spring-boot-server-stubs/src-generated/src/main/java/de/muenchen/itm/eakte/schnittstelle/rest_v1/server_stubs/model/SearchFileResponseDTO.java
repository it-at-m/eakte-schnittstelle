...
public class SearchFileResponseDTO {
  ...
  public SearchFileResponseDTO giobjecttype(List<@Valid Objektreferenz> giobjecttype) {
    this.giobjecttype = giobjecttype;
    return this;
  }

  public SearchFileResponseDTO addGiobjecttypeItem(Objektreferenz giobjecttypeItem) {
  ...
  public boolean equals(Object o) {
    ...
    SearchFileResponseDTO searchFileResponseDTO = (SearchFileResponseDTO) o;
    return Objects.equals(this.giobjecttype, searchFileResponseDTO.giobjecttype);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchFileResponseDTO {\n");
  ...
  public static class Builder {
    ...
    private SearchFileResponseDTO instance;

    public Builder() {
      this(new SearchFileResponseDTO());
    }

    protected Builder(SearchFileResponseDTO instance) {
      this.instance = instance;
    }

    protected Builder copyOf(SearchFileResponseDTO value) { 
      this.instance.setGiobjecttype(value.giobjecttype);
      return this;
    }

    public SearchFileResponseDTO.Builder giobjecttype(List<Objektreferenz> giobjecttype) {
      this.instance.giobjecttype(giobjecttype);
      return this;
    }
    
    /**
    * returns a built SearchFileResponseDTO instance.
    *
    * The builder is not reusable (NullPointerException)
    */
    public SearchFileResponseDTO build() {
      try {
  ...
  */
  public static SearchFileResponseDTO.Builder builder() {
    return new SearchFileResponseDTO.Builder();
  }

  /**
  * Create a builder with a shallow copy of this instance.
  */
  public SearchFileResponseDTO.Builder toBuilder() {
    SearchFileResponseDTO.Builder builder = new SearchFileResponseDTO.Builder();
