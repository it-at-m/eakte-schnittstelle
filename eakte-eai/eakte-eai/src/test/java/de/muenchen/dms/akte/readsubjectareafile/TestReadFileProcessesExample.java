...
public class TestReadFileProcessesExample {
  private TestReadFileProcessesExample() {}

  static ReadSubjectAreaFileGIObjectsResponse erzeugeAntwort() {
    final ObjectFactory objectFactory = new ObjectFactory();
    final ReadSubjectAreaFileGIObjectsResponse data =
        objectFactory.createReadSubjectAreaFileGIObjectsResponse();
    data.setStatus(0);
