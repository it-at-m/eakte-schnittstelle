...
class UpdateIncomingResponseProcessorTest {

  private static final int NO_ERROR_CODE = 0;
  private static final String OBJECT_COOID = "COO.1234.1234.1.1234";
  private static final String OBJECT_NAME = "objektname";

  private UpdateIncomingResponseProcessor processor;

  @BeforeEach
  public void setUp() {
    processor = new UpdateIncomingResponseProcessor();
  }
  ...
  private Exchange erzeugeExchangeObjekt(UpdateIncomingGIResponse response) {
  ...
  private void pruefeEAIAntwort(Exchange exchange) throws IOException {
    ...
    UpdateIncomingAntwortDTO antwort =
        mapper.createParser(body).readValueAs(UpdateIncomingAntwortDTO.class);
  ...
  private UpdateIncomingGIResponse erzeugeDmsAntwortOhneFehler() {

    UpdateIncomingGIResponse response = new UpdateIncomingGIResponse();
