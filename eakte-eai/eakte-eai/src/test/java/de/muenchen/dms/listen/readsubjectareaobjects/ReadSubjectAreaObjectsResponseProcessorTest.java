...
class ReadSubjectAreaObjectsResponseProcessorTest {

  private static final int NO_ERROR_CODE = 0;

  private ReadSubjectAreaObjectsResponseProcessor processor;

  @BeforeEach
  public void setUp() {
    processor = new ReadSubjectAreaObjectsResponseProcessor();
  }
  ...
  public Exchange erzeugeExchangeObjekt(ReadSubjectAreaGIObjectsResponse response) {
  ...
  public ReadSubjectAreaGIObjectsResponse erzeugeDmsAntwortOhneFehler() {
    ReadSubjectAreaGIObjectsResponse response = new ReadSubjectAreaGIObjectsResponse();
  ...
  private void pruefeEAIAntwort(Exchange exchange) throws IOException {
    ...
    ReadSubjectAreaObjectsAntwortDTO antwort =
        mapper.createParser(body).readValueAs(ReadSubjectAreaObjectsAntwortDTO.class);
