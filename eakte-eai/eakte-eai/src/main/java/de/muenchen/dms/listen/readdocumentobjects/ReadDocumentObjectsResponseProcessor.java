...
@Slf4j
@Component
public class ReadDocumentObjectsResponseProcessor extends AbstractResponseProcessor {
  @Override
  public void process(final Exchange exchange) throws Exception {
    ReadDocumentGIObjectsResponse response =
        exchange.getIn().getBody(ReadDocumentGIObjectsResponse.class);
    final ReadDocumentObjectsAntwortDTO objectResponse =
        ReadDocumentObjectsAntwortDTO.builder()
